...
//==============================================================================
// felitronics::poweramp::SagEnvelope — the pure, unit-testable power-supply SAG model. A
...
// tube squish, not a clean VCA duck. droop=0 ⇒ the un-sagged result is untouched.
//
// Pure: std only — header-only, embedded-safe, tested in isolation. Cross-referenced against OSS
// sag (SwankyAmp, Airwindows PowerSag) + textbook supply models; the physical plate/screen-split
// reservoir model (Amp Books) is a later refinement. Lifted verbatim from OrbitCab's tube power amp
// (cab::poweramp::SagEnvelope) — the numeric fingerprint is pinned by the module's golden battery.
//==============================================================================
